      ...
      {showAssignmentModal && selectedMeasure && (
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: '8px',
            padding: '24px',
            maxWidth: '700px', // Increased width for more content
            width: '90%',
            maxHeight: '85vh', // Allow for scrolling if content is tall
            overflowY: 'auto',
            ...
            <div style={{ 
              ...
              <form onSubmit={(e) => handleAssignSubmit(e, selectedMeasure.bestellnummer)}>
                <div style={{ marginBottom: '15px' }}>
